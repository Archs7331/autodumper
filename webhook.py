...
true = 'true'
false = 'false'
servname = config.get("servername")
servip = config.get("serverip")
...
attack_types = {
  ...
  "(Tftp Amp)": "17   69",
  "(KillAll/1)": "6   443",
  "(SSH FLOOD/1)": "0x00000002   22",
  "(SSH FLOOD/2)": "0x00000012   22",
  "(SSH FLOOD/3)": "0x00000018   22",
  "(SSH FLOOD/4)": "0x00000014   22",
  "(SSH FLOOD/5)": "0x00000010   22",
  "(KillAll/2)": "6   80",
  "(QOTD Amp)": "17    17",
  "(ISAKMP Amp)": "17    500",
  "(IPMI Amp)": "17    623",
  ...
  "embeds": [
    {
      ...
      "thumbnail": {
        "url": "https://cdn.discordapp.com/attachments/932472805453365268/932474691816415232/hakkarkat.gif"
      }
    }
  ]
}
